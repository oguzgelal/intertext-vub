...
In the first phase, we received 119 responses (after filtering out duplicate answers and answers with invalid worker ids). Information about participant demographics can be found in the \nameref{App:AppendixA}. Our results for the first phase are very positive, we were able to validate the problem and implement Intertext with more confidence.
...
\pie[pos={2.25,-3.9},radius=2,color={green!70,green!30,gray!30,red!40,red!70}]{12.6/,50.4/,21.0/,10.1/,5.9/}
